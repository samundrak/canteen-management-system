...
api.patch('/users/:id', requestValidator(userSchema), user.update);

/* Food api routes */
api.get('/foods', food.index);
api.post('/foods', requestValidator(foodSchema), food.create);
api.get('/foods/:id', food.show);
api.delete('/foods/:id', food.destroy);
api.patch('/foods/:id', requestValidator(foodSchema), food.update);
